...
Ext.layout.VBoxLayout = Ext.extend(Ext.layout.BoxLayout, {
    ...
    onLayout : function(ct, target){
        ...
        for (i = 0 ; i < csLen; i++) {
            ...
            if (!c.hasLayout && c.doLayout && !Ext.isNumber(c.width)) {
                c.doLayout();
            }
...
Ext.layout.HBoxLayout = Ext.extend(Ext.layout.BoxLayout, {
    ...
    onLayout : function(ct, target) {
        ...
        for (i = 0 ; i < csLen; i++) {
            ...
            if (!c.hasLayout && c.doLayout && !Ext.isNumber(c.height)) {
                c.doLayout();
            }
...
Ext.slider.Thumb = Ext.extend(Object, {
    ...
    onDragEnd: function(e){
        ...
        this.dragging = false;
        this.slider.fireEvent('dragend', this.slider, e);
        
        if(this.dragStartValue != this.value){
            this.slider.fireEvent('changecomplete', this.slider, this.value);
        }
    }
});
...
Ext.slider.MultiSlider = Ext.extend(Ext.BoxComponent, {
    ...
    /**
     * Attempts to remove the thumb at the given index
     * @param {Number} index The index of the thumb to remove
     */
